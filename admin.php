...
<?php if (!isset($_POST['upload'])) : ?>
    <a href="function/logout.php" class="back"><div>&lt;Выход</div></a>
    <!-- Если пользователь зашел как гость, то запретить загружать тесты -->

    <?php if (isAuthorized()) : ?>
        <h1>Здравствуйте, <span style="font-style: italic;"><?php echo $_SESSION['user']['name'] ?> (admin)</span></h1>
    ...
    <?php if (isQuest()) : ?>
        <h1>Здравствуйте, <span style="font-style: italic;"><?php echo $_SESSION['quest']['username'] ?> (quest)</span></h1>
    <?php endif; ?>
        <div class="all-tests">
            <fieldset>
